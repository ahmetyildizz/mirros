...
const CONFIG: Record<MatchLevel, { label: string; colorClass: string; icon: any; points: number }> = {
  EXACT:  { label: "TAM BİLDİN!",  colorClass: "text-green-500",  icon: CheckCircle2, points: 10 },
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        matchLevel === "EXACT" ? "border-green-500/30 shadow-[0_0_40px_rgba(34,197,94,0.2)]" : 
        matchLevel === "CLOSE" ? "border-yellow-500/30 shadow-[0_0_40px_rgba(234,179,8,0.2)]" : ""
      )}
    >
      <div className={cn("mb-4 p-4 rounded-full bg-white/[0.03]", cfg.colorClass)}>
